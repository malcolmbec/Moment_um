...
## name is given.) This screen must create a text displayable with id "what",
## as Ren'Py uses this to manage text display. It can also create displayables
## with id "who" and id "window" to apply style properties.
##
...
## pass a text prompt in. This screen must create an input displayable with id
## "input" to accept the various input parameters.
##
