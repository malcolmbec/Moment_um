...
## dialogue is displayed. After the game has started, this can be changed with
## the "window show", "window hide", and "window auto" statements.
...
define config.save_directory = "Moment_um-1587231671"
